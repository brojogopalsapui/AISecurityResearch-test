...
def patch_dark_brand_hints() -> None:
    for html in DARK.rglob('*.html'):
        ...
        text = text.replace('href="https://brojogopalsapui.github.io/AISecurityResearch-test/dark/" target="_blank" rel="noopener noreferrer">Mobile View (Dark)</a>', f'href="{root_index}">Light View</a>')
